       ...
       <div className="grid grid-cols-2 gap-4 mb-10">
         {filteredStyles.map(style => (
           <div
             ...
             className={`relative rounded-[2rem] overflow-hidden cursor-pointer border-4 transition-all active:scale-95 group ${
               selectedStyles.includes(style.id) ? 'border-primary scale-[1.02]' : 'border-transparent'
             }`}
           >
             ...
             {selectedStyles.includes(style.id) && (
               <div className="absolute top-4 right-4 w-7 h-7 bg-primary rounded-full flex items-center justify-center border-2 border-white">
