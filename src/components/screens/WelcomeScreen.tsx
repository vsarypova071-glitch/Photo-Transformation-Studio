  ...
  return <section className="min-h-screen flex flex-col items-center px-5 py-10 rounded-2xl">
      ...
      <div className="relative w-full max-w-sm aspect-[3/4] mb-10 rounded-[2rem] overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)]">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-7 text-left">
          <p className="text-[9px] uppercase tracking-[0.4em] mb-4 text-slate-50 font-semibold">
            AI Photo Studio
          </p>
          
          <h1 className="font-extralight leading-[1.2] mb-2 tracking-wide text-3xl">
            <span className="shimmer-text">Ваш идеальный</span><br />
            <span className="shimmer-text font-medium text-2xl">
              образ уже здесь
            </span>
          </h1>
